...
dt = 365 * 24 * 3600  # seconds in a year (one year)
...
shapefile_path = '/Users/tomdeboer/Documents/Universiteit/Master/Scriptie/Scriptie_240408_Tom_de_Boer/developing/controle/controle_input/shp/NL/Netherlands.shp'
...
plt.colorbar(c, ax=ax, label='Average Energy Consumption (kWh) - Low Efficiency')
...
plt.colorbar(c, ax=ax, label='Average Energy Consumption (kWh) - High Efficiency')
