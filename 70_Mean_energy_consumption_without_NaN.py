...
for idx_groundwater, idx_withdrawal in zip(year_indices_groundwater, year_indices_withdrawal):
    ...
    energy_low = calculate_energy(groundwater_depth_year, water_withdrawal_year, pump_efficiency_low)
    energy_high = calculate_energy(groundwater_depth_year, water_withdrawal_year, pump_efficiency_high)
    ...
    valid_pixel_counts += ~np.isnan(groundwater_depth_year) & ~np.isnan(water_withdrawal_year)
