...
well_data_path = '/Users/tomdeboer/Documents/Universiteit/Master/Scriptie/Scriptie_240408_Tom_de_Boer/developing/input/Lizard_PDOK_all_data_wells_location_depth_missing_value_percentage_with_months.csv'
...
# Definieer het kleurenschema gebaseerd op screen_bottom (screen_depth)
cmap = plt.cm.viridis  # Gebruik de kleurenschaal viridis
norm = plt.Normalize(vmin=-10, vmax=10)
well_gdf['color'] = well_gdf['screen_bottom'].apply(lambda x: cmap(norm(x)))
...
cbar.set_label('Screen Depth')

plt.title('Screen depth of wells in the Netherlands')
