...
gdf.plot(column='MissingDataPercentage', ax=ax, legend=True, cmap=cmap, markersize=50)

plt.title('Missing Data Percentages of Groundwater Level Timeseries Top Layer')
